...
export class SceneDetector {
  ...
  private hasProgressTasks: boolean;

  constructor(rules: SceneRule[] = DEFAULT_RULES) {
    this.rules = rules;
   ...
   * 设置是否有进行中的任务（用于默认规则）
   */
  setHasProgressTasks(hasProgress: boolean): void {
   ...
   * 获取场景规则详情
   */
  getSceneDetails(scene: string): SceneRule | undefined {
